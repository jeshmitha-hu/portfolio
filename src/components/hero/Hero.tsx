      ...
      <section id="home" className="hero">
        ...
        <div className="hero-wrapper">
          ...
          <div className="hero-left">
            ...
            <div className="typing-container">
              <TypeAnimation
                sequence={[
                  "Data Analyst", 1800,
                  "Business Intelligence Analyst", 1800,
                  "Power BI Developer", 1800,
                  "SQL Developer", 1800,
                  "AI Analytics Enthusiast", 1800,
                ]}
                wrapper="span"
                speed={45}
                repeat={Infinity}
          ...
          <div className="hero-right">
            <div className="hero-image">
              ...
              <img src="/images/profile.png" alt="Jeshmitha S" />
            </div>
          </div>
        ...
        <div className="hero-features">
          ...
          <div className="feature-card">
            ...
            <p>Identifying trends and solving business problems.</p>
          </div>

          <div className="feature-card">
            <div className="feature-icon"><FaCogs /></div>
            <h3>Automation</h3>
            <p>Streamlining workflows using Python, SQL and BI tools.</p>
          </div>

          <div className="feature-card">
            <div className="feature-icon"><FaRocket /></div>
            <h3>Continuous Learning</h3>
            <p>Exploring modern analytics & AI technologies.</p>
          </div>
        ...
        <div className="hero-social">
          ...
          <a href="https://github.com/jeshmitha-hu" target="_blank" rel="noreferrer">
            <FaGithub /> GitHub
          </a>

          <a href="https://www.linkedin.com/in/jeshmitha-s-77747034a" target="_blank" rel="noreferrer">
            <FaLinkedin /> LinkedIn
          </a>
